...
import { Camera, X, ChevronDown, Check, ArrowLeft, Phone } from "lucide-react";
            ...
            <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
              ...
              <div>
                ...
                <p className="text-[11px] text-gray-400 mb-2">
                  Ce numéro sera affiché sur l'annonce. Vous pouvez mettre un autre numéro que le vôtre.
                </p>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Ex: 0660 123 456"
                    className="w-full bg-gray-50 border border-gray-200 rounded-2xl pl-11 pr-4 py-3.5 text-sm outline-none focus:border-[#1B6B3A]"
                  />
                </div>
              </div>

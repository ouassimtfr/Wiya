  ...
  return (
    <div className="bg-white min-h-screen pb-28">
      ...
      <div className="bg-[#1B6B3A] pt-12 pb-4 px-4 flex items-center gap-3">
        <button onClick={() => navigate(-1 as any)} className="w-8 h-8 flex items-center justify-center rounded-full bg-white/20">
            ...
            <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-5">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                {photos.length < 5 && (
                  <button
                    onClick={addPhoto}
                    className="aspect-square rounded-xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center gap-1 text-gray-400 active:bg-gray-50"
                  >
            ...
            <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-4 py-3.5 text-sm outline-none focus:border-[#1B6B3A]"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full appearance-none bg-gray-50 border border-gray-200 rounded-2xl px-4 py-3.5 text-sm outline-none"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-4 py-3.5 text-sm outline-none focus:border-[#1B6B3A] resize-none"
                />
              </div>
                ...
                <div className="flex gap-2">
                  {(["new", "used"] as const).map((c) => (
                    <button
                      ...
                      className={`flex-1 py-3 rounded-2xl text-sm font-semibold transition-colors border-2
                        ${condition === c ? "border-[#1B6B3A] bg-green-50 text-[#1B6B3A]" : "border-gray-200 text-gray-500"}`}
                    >
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-4 py-3.5 text-sm outline-none focus:border-[#1B6B3A] pr-16"
                  />
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div
                    ...
                    className="flex items-center gap-3 p-4 bg-gray-50 rounded-2xl cursor-pointer"
                  >
                    <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-colors
                      ${opt.value ? "bg-[#1B6B3A] border-[#1B6B3A]" : "border-gray-300"}`}>

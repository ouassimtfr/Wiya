...
export const WILAYAS_DATA: Wilaya[] = [
  ...
  { code: 59, name: "Aflou", nameAr: "أفلو", lat: 34.11, lon: 2.10 },
  { code: 60, name: "El Abiodh Sidi Cheikh", nameAr: "الأبيض سيدي الشيخ", lat: 32.90, lon: 0.53 },
  { code: 61, name: "El Aricha", nameAr: "العريشة", lat: 34.28, lon: -1.27 },
  { code: 62, name: "El Kantara", nameAr: "القنطرة", lat: 35.22, lon: 5.68 },
  { code: 63, name: "Barika", nameAr: "بريكة", lat: 35.38, lon: 5.37 },
  { code: 64, name: "Bou Saâda", nameAr: "بوسعادة", lat: 35.21, lon: 4.18 },
  { code: 65, name: "Bir El Ater", nameAr: "بئر العاتر", lat: 35.75, lon: 8.07 },
  { code: 66, name: "Ksar El Boukhari", nameAr: "قصر البخاري", lat: 35.87, lon: 2.77 },
  { code: 67, name: "Ksar Chellala", nameAr: "قصر الشلالة", lat: 35.22, lon: 2.32 },
  { code: 68, name: "Aïn Oussera", nameAr: "عين وسارة", lat: 35.45, lon: 2.90 },
  { code: 69, name: "Messaad", nameAr: "مسعد", lat: 34.15, lon: 3.50 },
];
